...
public class TestMonirealSessionInfoOP {
  private static final Log log = LogFactory.getLog(TestMonirealSessionInfoOP.class);
  ...
  public void shouldCallTheOperation() throws OperationException, IOException {
    ...
    Blob doc = (JSONBlob) automationService.run(ctx, MonirealSessionInfoOP.ID);
