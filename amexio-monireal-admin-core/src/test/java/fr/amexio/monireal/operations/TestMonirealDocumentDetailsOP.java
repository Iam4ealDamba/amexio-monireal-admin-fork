...
public class TestMonirealDocumentDetailsOP {
    ...
    public void shouldCallTheOperation() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, MonirealDocumentDetailsOP.ID);
    ...
    public void shouldCallWithParameters() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, MonirealDocumentDetailsOP.ID, params);
