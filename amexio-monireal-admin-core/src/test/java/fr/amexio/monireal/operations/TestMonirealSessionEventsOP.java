...
public class TestMonirealSessionEventsOP {
  private static final Log log = LogFactory.getLog(TestMonirealSessionEventsOP.class);
  ...
  public void shouldCallTheOperation() throws OperationException, IOException {
    ...
    Blob doc = (Blob) automationService.run(ctx, MonirealSessionEventsOP.ID, params);
